...
- **`cookie-clicker-accessibility.user.js`** — Bundled Tampermonkey userscript for the web version. Generated by the build script; do not edit directly. Not tracked in git — only used as a release asset.
